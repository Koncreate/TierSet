...
export default class Picker extends Component {
              ...
              id={
                noSearchResults
                  ...
                  : this.props.previewEmoji ||
                    (this.props.previewPosition == "top" ? "point_down" : "point_up")
              }
              set={this.props.set}
          ...
          <div
            ...
            style={{
              ...
              backgroundColor: this.props.emojiButtonColors
                ? this.props.emojiButtonColors[(posinset - 1) % this.props.emojiButtonColors.length]
                : undefined,
            }}
          ></div>
          <Emoji
  ...
  renderSearch() {
    const renderSkinTone =
      this.props.previewPosition == "none" || this.props.skinTonePosition == "search";
  ...
  renderSearchResults() {
    ...
    return (
      <div class="category" ref={this.refs.search}>
        <div class={`sticky padding-small align-${this.dir[0]}`}>{I18n.categories.search}</div>
        <div>
