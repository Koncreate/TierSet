...
import ContentLoader, { BulletList, Code, Facebook, Instagram, List } from "../src/web";
...
export const gradientRatio = () => {
  ...
  foregroundColor={'#999'}
/>`}</SyntaxCode>
      <ContentLoader gradientRatio={0.2} backgroundColor={"#333"} foregroundColor={"#999"} />
  ...
  foregroundColor={'#999'}
/>`}</SyntaxCode>
      <ContentLoader gradientRatio={4} backgroundColor={"#333"} foregroundColor={"#999"} />
    </>
  );
};
...
>
  ...
  <rect x="12" y="61" rx="4" ry="4" width="270" height="12"></rect>
      ...
      <ContentLoader
        viewBox="0 0 300 88"
        beforeMask={
          <rect width="298" height="86" y="1" x="1" stroke="#dee0e3" strokeWidth="1" fill="#fff" />
        }
      >
        <rect x="12" y="13" rx="4" ry="4" width="20" height="20"></rect>
        <rect x="40" y="16" rx="4" ry="4" width="80" height="14"></rect>
