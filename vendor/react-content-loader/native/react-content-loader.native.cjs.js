...
var NativeSvg = /** @class */ (function (_super) {
  ...
  NativeSvg.prototype.render = function () {
    ...
    return React__default.createElement(
      Svg__default,
      __assign({ style: svgStyle }, props),
      beforeMask && React.isValidElement(beforeMask) ? beforeMask : null,
      React__default.createElement(Svg.Rect, {
        x: "0",
        y: "0",
        width: "100%",
        height: "100%",
        fill: "url(#".concat(this.idClip, ")"),
        clipPath: "url(#".concat(this.idGradient, ")"),
      }),
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          { id: this.idClip, x1: x1Animation, x2: x2Animation, y1: 0, y2: 0 },
          React__default.createElement(Svg.Stop, {
            offset: 0,
...
var ContentLoader = function (props) {
  return props.children
    ? React.createElement(NativeSvg, __assign({}, props))
...
var ReactContentLoaderFacebook = function (props) {
  return React.createElement(
    ContentLoader,
    __assign({ viewBox: "0 0 476 124", width: 476, height: 124 }, props),
...
var ReactContentLoaderInstagram = function (props) {
  return React.createElement(
    ContentLoader,
    __assign({ viewBox: "0 0 400 460", width: 400, height: 460 }, props),
...
var ReactContentLoaderCode = function (props) {
  return React.createElement(
    ContentLoader,
    __assign({ viewBox: "0 0 340 84", width: 340, height: 84 }, props),
...
var ReactContentLoaderListStyle = function (props) {
  return React.createElement(
    ContentLoader,
    __assign({ viewBox: "0 0 400 110", width: 400, height: 110 }, props),
...
var ReactContentLoaderBulletList = function (props) {
  return React.createElement(
    ContentLoader,
    __assign({ viewBox: "0 0 245 125", width: 245, height: 125 }, props),
