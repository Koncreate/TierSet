...
describe("ContentLoader snapshots", () => {
  ...
  test("renders correctly with viewBox empty", () => {
    const wrapper = renderer.create(<ContentLoader uniqueKey="snapshots" viewBox="" />);
    const tree = wrapper.toJSON();
  ...
  test("renders correctly with viewBox defined", () => {
    const wrapper = renderer.create(<ContentLoader uniqueKey="snapshots" viewBox="0 0 100 100" />);
    const tree = wrapper.toJSON();
  ...
  test("renders correctly with viewBox defined and sizes defined too", () => {
    const wrapper = renderer.create(
      <ContentLoader uniqueKey="snapshots" width={100} height={100} viewBox="0 0 100 100" />,
    );
    const tree = wrapper.toJSON();
