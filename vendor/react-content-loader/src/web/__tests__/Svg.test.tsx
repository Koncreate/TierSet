...
describe("Svg", () => {
  ...
  it("`baseUrl` is used correctly", () => {
    ...
    expect(rectClipPath.props.clipPath).toBe(`url(${baseUrl}#${clipPath.props.id})`);
    expect(rectClipPath.props.style.fill).toBe(`url(${baseUrl}#${linearGradient.props.id})`);
  });
  ...
  describe("unique key", () => {
    ...
    it("linearGradient id and rect clipPath fill are the same", () => {
      ...
      expect(rectClipPath.props.style.fill).toBe(`url(#${linearGradient.props.id})`);
    });
  });
